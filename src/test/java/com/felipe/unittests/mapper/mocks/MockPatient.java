...
//        patient.setId(UUID.fromString("0c38ae25-0d29-43ad-91d4-73e91309267b"));
        patient.setEmail("patient.email" + number + "@gmail.com");
        patient.setFullName("Full Name Test" + number);
        patient.setPassword("password01" + number);
        patient.setCpf("100.200.300-4" + number);
        patient.setBirthDate(DateUtil.convertStringToLocalDate("21/05/198" + number));
        patient.setPhone("(21) 3232-656" + number);
...
//        patient.setKey(UUID.fromString("1bf6842a-06f6-480d-b766-6e2725e86007"));
    ...
    public Patient mockRandomEntity(boolean withId) {
		...
		return new Patient(id, email, fullname, "senha123", cpf,
				DateUtil.convertStringToLocalDate("21/05/1981"), phone, "SulAmericano");
    }
