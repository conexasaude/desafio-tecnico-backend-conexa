...
import com.felipe.integrationtests.model.dto.AccessTokenDTO;
...
public class AuthControllerXmlTest extends AbstractIntegrationTest {
	private Logger logger = Logger.getLogger(AuthControllerXmlTest.class.getName());
	...
	public void testLogin() throws JsonMappingException, JsonProcessingException {
		String xmlDto = xmlMapper.writeValueAsString(new AccountCredentialsDTO(dto.getEmail(), dto.getPassword()));
	...
	public void testRefresh() throws JsonMappingException, JsonProcessingException {
		...
		String xmlAccessToken = xmlMapper.writeValueAsString(new AccessTokenDTO(accessToken));
