...
public class AttendanceService {
    ...
    @Transactional
    public ResponseEntity<AttendanceDTO> createAttendanceWithPatient(AttendanceDTO attendanceDTO) {
        ...
        // Salve o novo atendimento no banco de dados
        Attendance savedAttendance = attendanceRepository.save(newAttendance);

        // Converta o atendimento salvo para DTO e retorne
        return ResponseEntity.ok(attendanceMapper.toDto(savedAttendance));
    }
